<?php
//input:{"ID":"XX", "NickName":"X", "Email":"XXX", "Level":"XXX"}
...
if($data !="")
{
    ...
    if(isset($mydata["ID"]) && isset($mydata["NickName"]) && isset($mydata["Email"]) && isset($mydata["Level"])&& $mydata["ID"] != "" && $mydata["NickName"] != "" && $mydata["Email"] != "" && $mydata["Level"] != "")
    {
        $m_ID = $mydata["ID"];
        ...
        $sql = "UPDATE book_member SET NickName = '$m_NickName', Email = '$m_Email', Level = '$m_Level' WHERE ID = '$m_ID'";
